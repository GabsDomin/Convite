...
const gifts = [
  { id: "panos-prato", type: "fixed", section: "daily", name: "Kit de panos de prato", value: 70, category: "Cozinha", text: "Para deixar nossa cozinha mais prática no dia a dia.", status: "available" },
  { id: "descanso-panelas", type: "fixed", section: "daily", name: "Descanso de panelas", value: 70, category: "Cozinha", text: "Para cuidar da mesa nos almoços em casa.", status: "available" },
  { id: "pegadores-cozinha", type: "fixed", section: "daily", name: "Kit de pegadores de cozinha", value: 70, category: "Cozinha", text: "Para ajudar nos preparos e servir com carinho.", status: "available" },
  { id: "potes-tempero", type: "fixed", section: "daily", name: "Porta-temperos", value: 70, category: "Cozinha", text: "Para organizar os temperos da nossa casa.", status: "available" },
  { id: "jogo-americano", type: "fixed", section: "daily", name: "Jogo americano", value: 80, category: "Mesa", text: "Para montar uma mesa simples e bonita.", status: "available" },
  { id: "escorredor-louca", type: "fixed", section: "daily", name: "Escorredor de louça", value: 80, category: "Cozinha", text: "Para facilitar nossa rotina depois das refeições.", status: "available" },
  { id: "cesto-roupas", type: "fixed", section: "daily", name: "Cesto de roupas", value: 80, category: "Lavanderia", text: "Para ajudar na organização da lavanderia.", status: "available" },
  { id: "organizador-gaveta", type: "fixed", section: "daily", name: "Organizador de gavetas", value: 80, category: "Casa", text: "Para manter nosso novo lar mais arrumado.", status: "available" },
  { id: "tabua-corte", type: "fixed", section: "daily", name: "Tábua de corte", value: 90, category: "Cozinha", text: "Para os preparos do dia a dia na cozinha.", status: "available" },
  { id: "kit-copos-simples", type: "fixed", section: "daily", name: "Kit de copos para o dia a dia", value: 90, category: "Mesa", text: "Para receber visitas e compartilhar bons momentos.", status: "available" },
  { id: "porta-mantimentos", type: "fixed", section: "daily", name: "Porta-mantimentos", value: 90, category: "Cozinha", text: "Para deixar a despensa mais organizada.", status: "available" },
  { id: "lixeira-cozinha", type: "fixed", section: "daily", name: "Lixeira de cozinha", value: 90, category: "Cozinha", text: "Para completar os itens essenciais da casa.", status: "available" },
