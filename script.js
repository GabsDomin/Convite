...
let gifts = [
  ...
  { id: "kit-limpeza", type: "fixed", section: "daily", name: "Kit Limpeza", value: 40, category: "Lavanderia", text: "Para deixar a casa sempre limpa e cheirosa 🧽", status: "available" },
  ...
  { id: "caixa-organizadora", type: "fixed", section: "daily", name: "Caixa organizadora", value: 45, category: "Lavanderia", text: "Para guardar tudo com mais praticidade 📦", status: "available" },
  ...
  { id: "panela-de-pressao", type: "fixed", section: "daily", name: "Panela de pressão", value: 119, category: "Cozinha", text: "Para preparar refeições práticas com muito carinho 🍲", status: "available" },
  { id: "so-para-dizer-que-nao-dei-nada", type: "fixed", section: "daily", name: "Só para dizer que eu não dei nada", value: 40, category: "Brincadeira", text: "Para participar da lista sem perder a pose 😄", status: "available" },
  { id: "calvice-do-noivo", type: "fixed", section: "daily", name: "Ajuda no tratamento de calvice do noivo", value: 300, category: "Brincadeira", text: "Uma força para manter o brilho no grande dia 💇‍♂️", status: "available" },
  { id: "calmante-dia-casamento", type: "fixed", section: "daily", name: "Calmante para o dia do casamento", value: 35, category: "Brincadeira", text: "Para respirar fundo e aproveitar cada segundo 😌", status: "available" },
  { id: "tres-meses-corte-cabelo-noivo", type: "fixed", section: "daily", name: "3 meses de corte de cabelo do noivo", value: 105, category: "Brincadeira", text: "Para o noivo chegar sempre alinhado ✂️", status: "available" },
  { id: "tampao-ouvido-noivo-roncar", type: "fixed", section: "daily", name: "Tampão de ouvido para não ouvir o noivo roncar", value: 70, category: "Brincadeira", text: "Para garantir noites de paz no novo lar 😴", status: "available" },
  { id: "curso-culinaria-noiva", type: "fixed", section: "daily", name: "Curso de culinária da noiva", value: 90, category: "Brincadeira", text: "Para receitas cheias de carinho e coragem 👩‍🍳", status: "available" },
  { id: "jantar-romantico-noivos", type: "fixed", section: "daily", name: "Jantar romântico dos noivos", value: 200, category: "Brincadeira", text: "Para celebrar o amor com uma noite especial 🍝", status: "available" },
  { id: "deus-tocar-coracao", type: "fixed", section: "daily", name: "Se Deus tocar no seu coração", value: 300, category: "Brincadeira", text: "Para contribuir com fé, amor e generosidade 🙏", status: "available" },
  { id: "cueca-sexy-nupcias", type: "fixed", section: "daily", name: "Cueca Sexy para as nupcias", value: 60, category: "Brincadeira", text: "Para entrar no clima com bom humor 😎", status: "available" },
  { id: "levar-marmita-pra-casa", type: "fixed", section: "daily", name: "Levar marmita pra casa", value: 100, category: "Brincadeira", text: "Para garantir comida boa depois da festa 🍱", status: "available" },
  { id: "aviaozinho-tio-silvo", type: "fixed", section: "daily", name: "Aviãozinho do tio Silvo", value: 230, category: "Brincadeira", text: "Para animar a festa com estilo e nostalgia ✈️", status: "available" },
  ...
  { id: "cobertor", type: "fixed", section: "daily", name: "Cobertor", value: 150, category: "Quarto", text: "Para deixar nossas noites mais quentinhas 🛌", status: "available" },
