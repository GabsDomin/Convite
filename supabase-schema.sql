...
values
  ...
  ('calvice-do-noivo', 'Ajuda no tratamento de calvice do noivo', 'fixed', 'home', 'Casa', 'Uma força para manter o brilho no grande dia 💇‍♂️', 300, null, null, 245),
  ...
  ('aviaozinho-tio-silvo', 'Aviãozinho do tio Silvo', 'fixed', 'daily', 'Casa', 'Para animar a festa com estilo e nostalgia ✈️', 230, null, null, 205),
