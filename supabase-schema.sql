...
values
  ...
  ('so-para-dizer-que-nao-dei-nada', 'Só para dizer que eu não dei nada', 'fixed', 'daily', 'Brincadeira', 'Para participar da lista sem perder a pose 😄', 40, null, null, 161),
  ('calvice-do-noivo', 'Ajuda no tratamento de calvice do noivo', 'fixed', 'daily', 'Brincadeira', 'Uma força para manter o brilho no grande dia 💇‍♂️', 300, null, null, 162),
  ('calmante-dia-casamento', 'Calmante para o dia do casamento', 'fixed', 'daily', 'Brincadeira', 'Para respirar fundo e aproveitar cada segundo 😌', 35, null, null, 163),
  ('tres-meses-corte-cabelo-noivo', '3 meses de corte de cabelo do noivo', 'fixed', 'daily', 'Brincadeira', 'Para o noivo chegar sempre alinhado ✂️', 105, null, null, 164),
  ('tampao-ouvido-noivo-roncar', 'Tampão de ouvido para não ouvir o noivo roncar', 'fixed', 'daily', 'Brincadeira', 'Para garantir noites de paz no novo lar 😴', 70, null, null, 166),
  ('curso-culinaria-noiva', 'Curso de culinária da noiva', 'fixed', 'daily', 'Brincadeira', 'Para receitas cheias de carinho e coragem 👩‍🍳', 90, null, null, 167),
  ('jantar-romantico-noivos', 'Jantar romântico dos noivos', 'fixed', 'daily', 'Brincadeira', 'Para celebrar o amor com uma noite especial 🍝', 200, null, null, 168),
  ('deus-tocar-coracao', 'Se Deus tocar no seu coração', 'fixed', 'daily', 'Brincadeira', 'Para contribuir com fé, amor e generosidade 🙏', 300, null, null, 169),
  ('cueca-sexy-nupcias', 'Cueca Sexy para as nupcias', 'fixed', 'daily', 'Brincadeira', 'Para entrar no clima com bom humor 😎', 60, null, null, 171),
  ('levar-marmita-pra-casa', 'Levar marmita pra casa', 'fixed', 'daily', 'Brincadeira', 'Para garantir comida boa depois da festa 🍱', 100, null, null, 172),
  ('aviaozinho-tio-silvo', 'Aviãozinho do tio Silvo', 'fixed', 'daily', 'Brincadeira', 'Para animar a festa com estilo e nostalgia ✈️', 230, null, null, 173),
