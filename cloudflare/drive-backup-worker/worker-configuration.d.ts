/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.\cloudflare\drive-backup-worker\wrangler.jsonc .\cloudflare\drive-backup-worker\worker-configuration.d.ts` (hash: 1ad52e53b86be86addfa16afab14328e)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 nodejs_compat
interface __BaseEnv_Env {
	ALBUM_BUCKET: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL">> {}
}
